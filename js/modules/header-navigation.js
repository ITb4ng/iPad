...
export const initHeaderAndNavigation = () => {
  ...
  /* ==========================================================================
     검색 포커스 상태
     - 키보드로 검색창에 들어온 경우에만 포커스 스타일을 보여줍니다.
     - 마우스나 터치로 들어온 경우에는 포커스 스타일을 숨깁니다.
     ========================================================================== */
  ...
  /* 키보드 입력 상태 추적
     - Tab / Enter / Space / 방향키로 탐색하면 키보드 입력으로 봅니다.
     - 마우스 포인터나 터치 입력이 들어오면 키보드 입력 상태를 해제합니다. */
